...
export const mockOperationLogs: OperationLogRecord[] = [
  {
    ...
    module: '计划管理',
    operationType: '修改',
    content: '修改计划“天猫经营日报”执行时间',
    result: 'success',
    ip: '10.18.2.16',
    changes: [{ field: '执行时间', before: '08:00', after: '09:00' }],
  },
  {
    id: 'portal-delete-store',
    tenantId: 'tenant-aa',
    source: 'portal',
  ...
  {
    id: 'portal-import-store-accounts',
    tenantId: 'tenant-aa',
    source: 'portal',
  ...
  {
    id: 'portal-favorite-data-source',
    tenantId: 'tenant-aa',
    source: 'portal',
